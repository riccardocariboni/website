...
function processCommand(command) {
    ...
    // Example commands
    if (command === "help") {
        response.innerHTML = "<br>Available commands:<br><br>&emsp;<b>about</b> - More about me<br>&emsp;<b>help</b> - Show this message<br>&emsp;<b>clear</b> - Clear the console window<br>&emsp;<b>cookies</b> - Show the cookies policy of this website<br><br>";
    } else if (command === "clear") {
        terminal.innerHTML = "";
        terminal.appendChild(commandInput.parentNode);
        return;
    } else if (command === "cookies") {
        response.innerHTML = "<br>This website does not use any type of cookies or other tracking technologies<br><br>";
